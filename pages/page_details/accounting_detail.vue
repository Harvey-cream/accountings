    ...
    const newData = [
      {
        ...
        items: [
          { id: (lastId + 1) * 100 + 1, title: '育儿费用', amount: '-4,225.00', time: '14:20', location: '幼儿园生活区', icon: 'smile-o', iconBg: 'bg-amber-light', iconColor: '#d97706' },
          { id: (lastId + 1) * 100 + 2, title: '办公租赁', amount: '-6,466.00', time: '10:30', location: '科技园园区', icon: 'shop-o', iconBg: 'bg-blue-light', iconColor: '#2563eb' },
          { id: (lastId + 1) * 100 + 3, title: '交通保险', amount: '-5,555.00', time: '09:15', location: '私家车月度车险', icon: 'logistics', iconBg: 'bg-purple-light', iconColor: '#9333ea' }
        ]
      },
      {
        id: lastId + 2,
        ...
        items: [
          { id: (lastId + 2) * 100 + 1, title: '医疗健康', amount: '-5,225.00', time: '16:45', location: '市立医院', icon: 'hospital-o', iconBg: 'bg-emerald-light', iconColor: '#059669' }
        ]
      }
    ];
